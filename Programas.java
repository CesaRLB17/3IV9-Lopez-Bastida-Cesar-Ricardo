...
class Programas{
    public static void main(String[] args){
        ...
        int base, altura, opcion, perimetro, edad, abono, abono2, socios, decimalInicial, grados, dulce, agua, helado, picafresa, helicoptero, monto;
        char letra;
        double resultado, grados2, uno, dos, tres, primero, segundo;

        do{
        System.out.println("ESTE PROGRAMA FUE ELABORADO POR 3IV9_LOPEZ_BASTIDA_CESAR_RICARDO");
        System.out.println("Elija el Programa que desea ejecutar: ");
        System.out.println("1.Descuentos: ");
        System.out.println("2.Conversión decimal a binario: ");
        ...
        System.out.println("6.Calcular perímetro, área y volumen: ");
...
System.out.println("dulce-$3. botella de agua-$8. helado-$13. picafresa-$1.");

System.out.println("Por favor, digite cuantos dulces ha adquirido.");
dulce = entrada.nextInt()*3;
if (dulce<0){
    System.out.println("Digite un número valido");
}else{

System.out.println("Por favor, digite cuanta botellas de agua ha adquirido.");
...
System.out.println("Por favor, digite cuantas picafresas ha adquirido.");
picafresa = entrada.nextInt()*1;
if (picafresa<0){
...
monto = (dulce + agua + helado + picafresa);
